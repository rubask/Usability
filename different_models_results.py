...
class IAClusterPredictor:
    ...
    def hyperparameter_tuning(self, X, y, model_name='random_forest'):
        ...
        return best_model, scaler, grid_search.best_params_
    
    def get_feature_importance(self, model, feature_names, model_type='tree_based'):
    ...
    def predict_new_data(self, model, scaler, new_data):
...
if __name__ == "__main__":
    ...
    tuned_model, tuned_scaler, best_params = predictor.hyperparameter_tuning(X, y, 'random_forest')
